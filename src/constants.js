...
import moreLogo from "./assets/work_logo/more.png";
...
export const projects = [
  ...
  },
  {
    id: 1,
    title:
      "Baby Bites to Golden Delights – Healthy Recipes & Tips for All thys",
    description:
  ...
  {
    id: 2,
    title: "Dynamic real estate platform (Laravel backend and React)",
    description:
      "More Realty is a modern, dynamic real estate platform where users can buy, sell, and explore properties with ease. Implemented dynamic CMS and real-time data fetching, allowing instant property updates through the admin dashboard.Designed a scalable real estate web platform supporting property buying, selling, and detailed listing management. Designed a modern, responsive, and high-performance user interface, ensuring a smooth user experience.",
    image: moreLogo,
    tags: [
      "HTML",
      "CSS",
    ...
    github: "https://github.com/mizanurmillon/real-estate-platform-",
    AdminDashboard: "https://morerealty1.thewarriors.team/",
    webapp: "https://more-reality.vercel.app/",
  },
